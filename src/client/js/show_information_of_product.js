...
function showInformation (goodInformation) {
    ...
    function informationOutput() {
        if (!document.getElementById(goodInformation["name_of_product"] + " name")) {
            ...
            let contentHtml = '<p id="' + nameOfProduct + ' name"><strong>Product information:</strong> ' + nameOfProduct + '</p>' +
                '<p id="' + nameOfProduct + ' description"><strong>Description: </strong>' + descriptionOfProduct + '</p>';
